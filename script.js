...
/***/ "../WindowsLandingJS/src/js/modules/clearObject.js":
/*!*********************************************************!*\
  !*** ../WindowsLandingJS/src/js/modules/clearObject.js ***!
  \*********************************************************/
...
var clearObject = function clearObject(state) {
...
/* harmony import */ var _modules_fillingObj__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/fillingObj */ "./src/js/modules/fillingObj.js");
...
/* harmony import */ var _modules_showMoreStyle__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/showMoreStyle */ "./src/js/modules/showMoreStyle.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_13__["default"])('.feedback-slider-item', 'horizontal', '.main-prev-btn', '.main-next-btn', 1);
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_13__["default"])('.main-slider-item', 'vertical', '', '', 1);
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_7__["default"])(state);
  ...
  Object(_modules_showMoreStyle__WEBPACK_IMPORTED_MODULE_12__["default"])('.button-styles', '#styles .row');
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_2__["default"])('#size', '#material', '#options', '.promocode', '.calc-price', '.calc-form .button-order');
  ...
  Object(_modules_fillingObj__WEBPACK_IMPORTED_MODULE_5__["default"])(state);
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var calc = function calc(size, material, options, promocode, result, btnSelector) {
...
var drop = function drop() {
  ...
  function unHighLight(item) {
    ...
    if (item.closest('.calc-form')) {
      item.closest('.file_upload').style.cssText = "background-color: #fff";
    } else {
      item.closest('.file_upload').style.cssText = "background-color: #ededed";
    }
  }

  function bindListener(foo) {
  ...
  bindListener(highLight, 'dragenter', 'dragover');
  bindListener(unHighLight, 'dragleave', 'drop');
  fileInputs.forEach(function (input) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var fillingObj = function fillingObj(state) {
  ...
  bindActionToElems('DOMSubtreeModified', price, 'price');
...
/* harmony default export */ __webpack_exports__["default"] = (fillingObj);
...
/* harmony import */ var _WindowsLandingJS_src_js_modules_clearObject__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../WindowsLandingJS/src/js/modules/clearObject */ "../WindowsLandingJS/src/js/modules/clearObject.js");
...
var forms = function forms(state) {
  ...
  forms.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      console.log(api);
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_10__["postData"])(api, json).then(function (data) {
        console.log(data);
        ...
        clearInputs();
        Object(_WindowsLandingJS_src_js_modules_clearObject__WEBPACK_IMPORTED_MODULE_9__["default"])(state);
...
var pictureSize = function pictureSize(imgSelector) {
  ...
  function hideImg(block) {
    ...
    block.querySelectorAll('p').forEach(function (el) {
...
var slider = function slider(slides, dir, prevArr, nextArr, step) {
  var slideIndex = 1,
      paused = false;
  ...
  try {
    var prevBtn = document.querySelector(prevArr),
